...
import { WORKFLOWS, COLUMNS } from './data'
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex gap-2">
          <button onClick={() => setActiveType('all')} className={cn("flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors", activeType === 'all' ? "bg-blue-600 text-white" : "bg-white text-slate-600 border border-slate-200 hover:bg-slate-50")}>
            <Filter className="w-3.5 h-3.5" /> All
          </button>
          <button onClick={() => setActiveType('student')} className={cn("flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors", activeType === 'student' ? "bg-blue-600 text-white" : "bg-white text-slate-600 border border-slate-200 hover:bg-slate-50")}>
            <User className="w-3.5 h-3.5" /> Student
          </button>
          <button onClick={() => setActiveType('faculty')} className={cn("flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors", activeType === 'faculty' ? "bg-blue-600 text-white" : "bg-white text-slate-600 border border-slate-200 hover:bg-slate-50")}>
            <Award className="w-3.5 h-3.5" /> Faculty
          </button>
          <button onClick={() => setActiveType('admin')} className={cn("flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors", activeType === 'admin' ? "bg-blue-600 text-white" : "bg-white text-slate-600 border border-slate-200 hover:bg-slate-50")}>
